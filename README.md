...
## 第五十八周（2025.1.27-2025.2.2）

> 春节快乐，蛇年大吉

+ 最近DeepSeek很火

## 第五十九周（2025.2.3-2025.2.9）

> 还有不到两个月，加油

+ 啥事也没发生

## 第六十周（2025.2.10-2025.2.16）

> 备考

+ 听说国护5月开始了,不知道能不能去混

## 第六十一周（2025.2.17-2025.2.23）
...
## 第六十二周（2025.2.24-2025.3.2）

> 备考、科目二

+ 科目二过了

## 第六十三周（2025.3.3-2025.3.9）
...
## 第六十六周（2025.3.24-2025.3.30）

> 考试顺利

+ 炸了，预测450分，保底公办吧

## 第六十七周（2025.3.31-2025.4.6）
...
## 第七十五周（2025.5.26-2025.6.1）

> 躺尸

+ 回家第二次考科目三过了！

## 第七十六周（2025.6.2-2025.6.8）
...
## 第八十六周（2025.8.11-2025.8.17）

> 健身房

+ 健身房

## 第八十七周（2025.8.18-2025.8.24）
...
## 第八十八周（2025.8.25-2025.8.31）

> 学习

+ https://xz.aliyun.com/news/18582 BOF开发

## 第八十九周（2025.9.1-2025.9.7）
...
## 第九十周（2025.9.8-2025.9.14）

> 兼职、这周开学

+ 又接了个培训的活，武汉真是狠人多
  + 甲方太抽象了，wp居然都复现不出来，没办法只能手把手教了
  + 被夸是他们这几年来能力最好的老师，:D 开心
+ 开学的校园网问题最近解决一下吧，弄个随身WiFi
  + 老毛子路由器固件锐捷认证

## 第九十一周（2025.9.15-2025.9.21）

> 领奖

+ 在本市的网络安全宣传周顺便领了个“先进人才”奖

## 第九十二周（2025.9.22-2025.9.28）

> 校园生活

+ 最近迷上了吃鸡柳大人

## 第九十三周（2025.9.29-2025.10.5）

> 国庆节快乐

+ 国庆后要好好学习了

## 第九十四周（2025.10.6-2025.10.12）

> 备考CET6

+ rt

## 第九十五周（2025.10.13-2025.10.19）

> hvv发工资了

+ rt

## 第九十六周（2025.10.20-2025.10.26）

> 理财中

+ rt

## 第九十七周（2025.10.27-2025.11.2）

> 迷上三角洲了

+ rt

## 第九十八周（2025.11.3-2025.11.9）

> 选题

+ 基于GO的Windows终端集中安全管制系统

## 第九十九周（2025.11.10-2025.11.16）
...
## 第一百周（2025.11.17-2025.11.23）

> 研究期末考试

+ 写程序中

## 第一百零一周（2025.11.24-2025.11.30）

> 沉迷大学生活了

+ 给学校机房开发了个东西

## 第一百零二周（2025.12.1-2025.12.7）

> 弄了个GO项目

+ 项目用来中间人抓包，明明很简单就可以落地，但我没弄服务器来接收数据，弄的临时的导致失效了

## 第一百零三周（2025.12.8-2025.12.14）

> 机房项目优化

+ DuplicateHandle,VSS technique读取占用中的程序数据（类似于hackbrowser）

## 第一百零四周（2025.12.15-2025.12.21）

> 很想考OSCE3

+ osed+oswe+osep 考完人就是神了

## 第一百零五周（2025.12.22-2025.12.28）

> 记录下

+ https://zhuanlan.zhihu.com/p/601440880 GO多版本共存
+ https://github.com/TheMoonu/SNOWCTF CTF平台

## 第一百零六周（2025.12.29-2026.1.4）

> 新年快乐

+ 这周忘记了，反正新年快乐

## 第一百零七周（2026.1.5-2026.1.11）

> 准备去当jl员

+ 感觉正式步入了这个组织

## 第一百零八周（2026.1.12-2026.1.18）

> CISCN

+ 被ban了，因为别人用我们wp中原图，被查重了
+ 17年以来学校第一次没进线下被痛骂

## 第一百零九周（2026.1.19-2026.1.25）
...
## 第一百一十周（2026.1.26-2026.2.1）

> jl员封闭式生活

+ 也是搞了下大数据安全相关的，也就处理提取脱敏
+ 感觉这里PYCC给的帮助蛮大的，但没有运用上就是了

## 第一百一十一周（2026.2.2-2026.2.8）

> 想学习了

+ https://github.com/0xsdeo/AntiDebug_Breaker JS逆向插件
+ https://xz.aliyun.com/news/19143 win 剪贴板后渗透
  + 缺少自动添加打开剪贴板注册表和上传数据的功能
  + Go to HKEY_CURRENT_USER\Software\Microsoft\Clipboard and change EnableClipboardHistory to 1
...
+ inshuju.net 良心的数据上传接口
+ https://github.com/LDAx2012/mimikatz win11可用

## 第一百一十二周（2026.2.9-2026.2.15）
...
## 第一百一十三周（2026.2.16-2026.2.22）

> 春节

+ 新春快乐

## 第一百一十四周（2026.2.23-2026.3.1）
...
+ https://github.com/VirtualAlllocEx/HWBP-DEP-Bypass
  + 一个隐蔽的DEP加载shellcode方法
+ https://github.com/0xNinjaCyclone/AsmLdr

## 第一百一十九周（2026.3.30-2026.4.5）

> 累

+ 最近在忙于某项目，比赛也鸽了一个，清明后也是在搞这个项目，钱少活多，每天加班，睡6小时不到

## 第一百二十周（2026.4.6-2026.4.12）

> Claude Code NB!

+ 但是在项目中，和福star的小伙伴进行了交流，他们agent使用能力是真强
+ 也是用CC实现了好多以前想实现，想优化的史山代码
+ 包括但不限于：playwright登录brute 验证码,可交互仿真蜜罐,我的EDR,我的SHC,某些平台
+ codex其实也不错，但我CLINE搭配CC真的是无敌了

## 第一百二十一周（2026.4.13-2026.4.19）

> 依旧上班

+ 这周 是正式开始，住酒店，吃酒店，伙食太好了，就是项目实在逆天，加班到这么晚也是无敌，也没加班费（苦了我找的两个小兄弟）

## 第一百二十二周（2026.4.20-2026.4.26）
...
## 第一百四十周（2026.8.24-2026.8.30）

> hvv

+ 真正的工业级反注入方案，永远是Hook（实时性） + VAD（覆盖度） + 行为链（上下文）的组合拳。

## 第一百四十一周（2026.8.31-2026.9.6）

> hvv结束了

+ 将自己的c2以及各种工具都通过GLM5.3做了细致优化

## 第一百四十二周（2026.9.7-2026.9.13）

> 持续vibe

+ 弄了一个agent，我的设计理念是：简单的设计思路，解决简单的问题。不要为了"优雅"引入复杂度。每个设计决策都问自己：这真的需要这么复杂吗？